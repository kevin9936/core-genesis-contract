...
class ChainChecker:
    ...
    def check_btc_stake_history_reward(self, delegator):
        ...
        assert_result(addr_to_name(delegator)+"_btc_stake_claimable_reward", claimable_reward, claimable_reward_on_chain)
        assert_result(addr_to_name(delegator)+"_btc_stake_unclaimable_reward", unclaimable_reward, unclaimable_reward_on_chain)
