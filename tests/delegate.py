...
INPUT_TX_ID = '0x1ba59f247e7aaba7d7aa3360e718dcdcc43d83e499573dc64f1e4152ac000436'
SCRIPT_SIG = '473044022046e23b8f6b749a15b0571848fe2b86bfbe7e158b23f37fb0335be0a71f48a5dd022076640b2d39659c26224c9e67101b34e1394a38ff08a4bdd88d7503f63e54adc5012103b3e19c8169b81d15ec21f9d0f3ed4b2f18c7c9e1149ce5f7ddebed7732724b9f'
...
def build_btc_transaction(btc_tx_info):
    ...
    print('build_btc_transaction>>>>>>', btc_tx_info)
    return btc_tx
...
def build_btc_lst_tx(delegator, amount, pay_address, input_tx_id=None, vout=0, fee=1, version=2,
    ...
    print('build_btc_lst_tx>>>>>>>>>', btc_tx_info)
    return btc_tx
...
def set_last_round_tag(stake_round, time0=None):
    ...
    print('set_last_round_tag>>>>>>>', end_round0, current_round)
...
def transfer_coin_success(source_agent, target_agent, amount, delegator):
...
def delegate_btc_lst_success(delegator, btc_amount, lock_script, percentage=5000, relay=None):
    ...
    print('delegate_btc_lst_success>>>>>>>', btc_tx0)
    tx_id = get_transaction_txid(btc_tx0)
    return tx_id
...
# old delegate 
def old_delegate_coin_success(candidate, account=None, amount=None, old=True):
    if account is None:
        account = accounts[0]
    if amount is None:
        amount = 10000
...
def old_transfer_coin_success(source_agent, target_agent, account=None, amount=0, old=True):
    if account is None:
        account = accounts[0]
    if old is True:
...
def old_turn_round(miners: list = None, tx_fee=100, round_count=1):
    ...
    for _ in range(round_count):
        ...
        chain.sleep(1)
    print('old_turn_round>>>>>>>>', get_current_round())
    return tx
...
class BtcScript:
    ...
    def k2_btc_lst_script(lock_public_key, lock_script_type='p2sh'):
        ...
        if lock_script_type == AddressType.P2SH:  # 23 bytes
            ...
            print('lock_script:>>>>P2SH', lock_script)
...
class BtcStake:
    ...
    def build_btc(self, inputs, outputs, opreturn):
        ...
        print('build_btc_transaction>>>>>>', self.btc_tx_info)
