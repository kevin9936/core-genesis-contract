...
//        BTC_UNIT_CONVERSION = BTC_UNIT_CONVERSION / 1e9 / 2;
    ...
    function setInitLpRates(uint value1, uint balue01, uint value2, uint balue02, uint value3, uint balue03) external {
        lpRates.push(LP(value1, balue01));
        lpRates.push(LP(value2, balue02));
        lpRates.push(LP(value3, balue03));
    }

    function setLpRates(uint value1, uint balue01) external {
        lpRates.push(LP(value1, balue01));
    }
    ...
    function setBtcPoolRate(uint256 value) external {
        btcPoolRate = value;
    }
    ...
    function initHybridScoreMock() external {
        ...
        require(success, "call BTC_AGENT_ADDR._initializeFromPledgeAgent fail");
